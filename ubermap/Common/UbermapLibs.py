...
class UbermapConfig:
    ...
    def to_string(self, name, subdir, log_enabled):
        self.load(name, subdir, log_enabled)
        return str(self._config_cache[name])
...
class UbermapConfigProxy:
    ...
    def to_string(self):
        return self.config_provider.to_string(self.name, self.subdir, self.log_enabled)
